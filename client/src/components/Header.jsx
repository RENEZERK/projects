  ...
  return (
    <div className='mx-8 sm:mx-16 xl:mx-24 relative'>
      <div className='text-center mt-20 mb-8'>
        ...
        <form onSubmit={onSubmitHandler} className='flex items-center max-w-lg mx-auto border rounded overflow-hidden'>
          <input ref={inputRef}
            type='text'
      ...
      <div className='text-center'>
        {
        input && <button onClick={onClear} className='border font-light text-xs py-1 px-3 rounded shadow-custom-sm cursor-pointer rounded-sm'>Clear Search</button>}
      </div>
      <img
